...
Al correr el codigo vimos que era infactible cumplir con toda la demanda tras agregar esta restriccion
...
```{zpl}
var ter[P*T] binary; #flag de si lo tercerizo o no
```
...
Como resultado obtenemos que la mínima capacidad del depósito que hace que el problema sea factible sea 705
