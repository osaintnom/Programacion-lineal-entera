...
Para esta nueva retriccion hemos necesitado un iterador mas para poder recorrer la variable ter (p_). Esto fue porque para cada proudcto tengo que ver si la variable bianria ter debe ser prendida o apagada, y no era posible usar p porque es el indice de la sumatoria. 
